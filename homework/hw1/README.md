...
|3| Учет заявок | Заявка | Зарегистрированный с системе запрос на выполнение работ. Запрос имеет атрибуты: статус, контрольный срок, назначенный исполнитель. ||
...
|6| Работа над заявками | Оборудование | Физическая сущность, которая хранится у исполнителя или используется в процессе выполнения заявки. Оборудование может быть установлено или демонтировано. Оборудование может быть 2-х типов "Серийное Оборудование" или "Расходные материалы" ||
|7| Работа над заявками | Серийное Оборудование | Оборудование, которое имеет уникальный идентификатор | |
|8| Работа над заявками | Расходные материалы | Оборудование, которое не имеет уникального идентификатора | |
...
|10| Работа над заявками | Реальный склад | Склад компании, на котором хранятся расходные материалы и серийное оборудование | склад |
